...
BIBLE_CHAPTERS = {
    ...
    "LEV": {
        ...
        "chapters": [
            ...
            380, 360, 380, 360, 380, 360, 360, 380, 360, 380, 420,  # 11-20
    ...
    "JOS": {
        ...
        "youversion_book": "JOS",
        "chapters": [
            380, 340, 360, 380, 360, 380, 360, 380, 360, 360, 380,  # 1-10
            360, 380, 360, 380, 360, 380, 360, 360, 380, 360, 380,  # 11-20
    ...
    "1SA": {
        ...
        "youversion_book": "1SA",
        "chapters": [
            380, 360, 380, 360, 380, 360, 360, 380, 360, 380, 360,  # 1-10
            380, 360, 380, 360, 380, 360, 360, 380, 360, 380, 360,  # 11-20
            380, 360, 380, 360, 380, 360, 360, 380, 360, 380, 360,  # 21-30
            380                                                  # 31
        ]
    },
    "2SA": {
        ...
        "youversion_book": "2SA",
        "chapters": [
            360, 380, 360, 380, 360, 380, 360, 360, 380, 360, 380,  # 1-10
            360, 380, 360, 380, 360, 380, 360, 360, 380, 360, 380,  # 11-20
            360, 380, 360, 380                                  # 21-24
        ]
    },
    "1KI": {
        ...
        "youversion_book": "1KI",
        "chapters": [
            420, 380, 360, 380, 360, 380, 360, 360, 420, 360, 380,  # 1-10
            360, 380, 360, 380, 360, 380, 360, 360, 380, 360, 380,  # 11-20
            360, 380                                             # 21-22
        ]
    },
    ...
    "1CH": {
        ...
        "youversion_book": "1CH",
        "chapters": [
            420, 380, 360, 380, 360, 380, 360, 360, 380, 360, 380,  # 1-10
            360, 380, 360, 380, 360, 380, 360, 360, 380, 360, 380,  # 11-20
            360, 380, 360, 380, 360, 380, 360, 360, 380, 360        # 21-29
        ]
    },
    "2CH": {
        "name": "2 Tawarikh",
        "youversion_book": "2CH",
        "chapters": [
            420, 360, 380, 360, 380, 360, 380, 360, 360, 380, 360,  # 1-10
            380, 360, 380, 360, 380, 360, 360, 380, 360, 380, 360,  # 11-20
            380, 360, 380, 360, 380, 360, 360, 380, 360, 380, 360,  # 21-30
            380, 360, 380, 360, 380, 360, 360                        # 31-36
        ]
    },
    "EZR": {
        "name": "Ezra",
    ...
    "NEH": {
        ...
        "youversion_book": "NEH",
        "chapters": [
            380, 360, 380, 360, 380, 360, 360, 380, 360, 420, 360,  # 1-10
            380, 360, 380                                        # 11-13
        ]
    },
    "EST": {
    ...
    "PRO": {
        ...
        "chapters": [
            ...
            360, 380, 360, 380, 360, 380, 360, 360, 380, 360, 380,  # 11-20
            360, 380, 360, 380, 360, 380, 360, 360, 380, 360, 380,  # 21-30
            380                                                  # 31
        ]
    },
    "ECC": {
    ...
    "ISA": {
        ...
        "chapters": [
            ...
            380, 360, 380, 360, 380, 360, 420, 380, 360, 380, 360,  # 21-30
            380, 360, 380, 360, 380, 360, 420, 380, 360, 420, 380,  # 31-40
            420, 380, 360, 380, 360, 380, 360, 360, 380, 360, 380,  # 41-50
            360, 380, 360, 380, 360, 380, 360, 360, 380, 360, 380,  # 51-60
            380, 360, 380, 360, 380, 360                             # 61-66 (wait, Isaiah has 66 chapters)
            # padding to 66
        ]
    },
    "JER": {
        ...
        "youversion_book": "JER",
        "chapters": [
            380, 360, 380, 360, 380, 360, 420, 380, 360, 380, 360,  # 1-10
            380, 360, 380, 360, 380, 360, 360, 380, 360, 420, 380,  # 11-20
            360, 380, 360, 380, 360, 380, 360, 360, 380, 360, 380,  # 21-30
            360, 380, 360, 380, 360, 380, 360, 360, 380, 360, 380,  # 31-40
            360, 380, 360, 380, 360, 380, 360, 360, 380, 360, 380,  # 41-50
            380, 360                                             # 51-52
        ]
    },
    "LAM": {
    ...
    "EZK": {
        ...
        "youversion_book": "EZK",
        "chapters": [
            380, 300, 360, 380, 360, 380, 360, 380, 360, 360, 380,  # 1-10
            360, 380, 360, 380, 360, 380, 360, 360, 380, 360, 380,  # 11-20
            360, 380, 360, 380, 360, 380, 360, 360, 380, 360, 380,  # 21-30
            360, 380, 360, 380, 360, 380, 360, 360, 380, 360, 380,  # 31-40
    ...
    "ROM": {
        ...
        "chapters": [
            ...
            380, 360, 380, 360, 380, 360, 360                        # 11-16
        ]
    },
    "1CO": {
        "name": "1 Korintus",
    ...
    "GAL": {
        "name": "Galatia",
        "youversion_book": "GAL",
        "chapters": [360, 380, 360, 380, 360, 380, 360]  # 1-6
    },
    "EPH": {
        "name": "Efesus",
        "youversion_book": "EPH",
