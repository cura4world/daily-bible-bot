...
BIBLE_CHAPTERS = {
    ...
    "LEV": {
        ...
        "chapters": [
            ...
            380, 360, 380, 360, 380, 360, 360, 380, 360, 380,  # 11-20
            420, 380, 360, 380, 360, 420, 380,                 # 21-27
        ]
    },
    "NUM": {
        "name": "Bilangan",
    ...
    "JOS": {
        ...
        "youversion_book": "JOS",
        "chapters": [
            380, 340, 360, 380, 360, 380, 360, 380, 360, 360,  # 1-10
            380, 360, 380, 360, 380, 360, 380, 360, 360, 380,  # 11-20
    ...
    "1SA": {
        ...
        "youversion_book": "1SA",
        "chapters": [
            380, 360, 380, 360, 380, 360, 360, 380, 360, 380,  # 1-10
            360, 380, 360, 380, 360, 380, 360, 360, 380, 360,  # 11-20
            380, 360, 380, 360, 380, 360, 380, 360, 360, 380,  # 21-30
            360,                                               # 31
        ]
    },
    "2SA": {
        ...
        "youversion_book": "2SA",
        "chapters": [
            360, 380, 360, 380, 360, 380, 360, 360, 380, 360,  # 1-10
            380, 360, 380, 360, 380, 360, 380, 360, 360, 380,  # 11-20
            360, 380, 360, 380,                                # 21-24
        ]
    },
    "1KI": {
        ...
        "youversion_book": "1KI",
        "chapters": [
            420, 380, 360, 380, 360, 380, 360, 360, 420, 360,  # 1-10
            380, 360, 380, 360, 380, 360, 380, 360, 360, 380,  # 11-20
            360, 380,                                          # 21-22
        ]
    },
    ...
    "1CH": {
        ...
        "youversion_book": "1CH",
        "chapters": [
            420, 380, 360, 380, 360, 380, 360, 360, 380, 360,  # 1-10
            380, 360, 380, 360, 380, 360, 380, 360, 360, 380,  # 11-20
    ...
    "2CH": {
        ...
        "youversion_book": "2CH",
        "chapters": [
            420, 360, 380, 360, 380, 360, 380, 360, 360, 380,  # 1-10
            360, 380, 360, 380, 360, 380, 360, 360, 380, 360,  # 11-20
            380, 360, 380, 360, 380, 360, 380, 360, 360, 380,  # 21-30
            360, 380, 360, 380, 360, 380,                      # 31-36
        ]
    },
    "EZR": {
        "name": "Ezra",
    ...
    "NEH": {
        ...
        "youversion_book": "NEH",
        "chapters": [
            380, 360, 380, 360, 380, 360, 360, 380, 360, 420,  # 1-10
            360, 380, 360,                                     # 11-13
        ]
    },
    "EST": {
    ...
    "ISA": {
        ...
        "chapters": [
            ...
            380, 360, 380, 360, 380, 360, 420, 380, 360, 380,  # 21-30
            360, 380, 360, 380, 360, 380, 360, 420, 380, 360,  # 31-40
            420, 380, 420, 380, 360, 380, 360, 380, 360, 360,  # 41-50
            380, 360, 380, 360, 380, 360, 380, 360, 380, 360,  # 51-60
            360, 380, 360, 380, 380, 360,                      # 61-66
        ]
    },
    "JER": {
        "name": "Yeremia",
        "youversion_book": "JER",
        "chapters": [
            380, 360, 380, 360, 380, 360, 420, 380, 360, 380,  # 1-10
            360, 380, 360, 380, 360, 380, 360, 360, 380, 360,  # 11-20
            420, 380, 360, 380, 360, 380, 360, 380, 360, 360,  # 21-30
            380, 360, 380, 360, 380, 360, 380, 360, 380, 360,  # 31-40
    ...
    "EZK": {
        ...
        "youversion_book": "EZK",
        "chapters": [
            380, 300, 360, 380, 360, 380, 360, 380, 360, 360,  # 1-10
            380, 360, 380, 360, 380, 360, 380, 360, 360, 380,  # 11-20
            360, 380, 360, 380, 360, 380, 360, 380, 360, 360,  # 21-30
            380, 360, 380, 360, 380, 360, 380, 360, 380, 360,  # 31-40
            360, 380, 360, 380, 420, 380, 420, 380,            # 41-48
        ]
    },
    "DAN": {
        "name": "Daniel",
...
# Reading order: NT epistles → Revelation → OT → Gospels/Acts → Pauline epistles → cycle
READING_ORDER = [
    "HEB",
...
def get_reading_plan(start_book="JAS", start_chapter=1):
    """
